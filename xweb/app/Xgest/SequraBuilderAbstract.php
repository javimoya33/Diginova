...
abstract class SequraBuilderAbstract {
	...
	protected function fixRoundingProblems($order) {
		...
		$order['cart']['order_total_with_tax']    = $totals['with_tax'];
	...
	public abstract function productItems();

	public abstract function discountItems();

	public abstract function feeItems();
