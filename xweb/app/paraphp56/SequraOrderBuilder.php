<?php
namespace App\Xgest;
//include('SequraBuilderAbstract.php');
...
class SequraOrderBuilder extends SequraBuilderAbstract {
	...
	public function deliveryMethod() {
		//return array("name" => 'Definido en la cesta', "days" => '');
	...
	public function customer() {
		$data = array(
			...
			'previous_orders' => $this->getPreviousOrders(1),
