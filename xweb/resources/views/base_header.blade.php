...
@if(session('usuario')->uData->codigo > 0)
  <div class="digiHeaderFila1" style="padding: 5px 0 3px 0;">
    <div class="div_main_header">
      <div class="digiHeaderCell dHF1_outOf dHF1_oferta" style="width: 24px; padding-right: 3px;">
        <div class="tHofe1" style="padding: 0 5px;">
          <a href="/xweb/favoritos">
            <img alt="Favoritos" title="Favoritos" width="18" height="16" src="/xweb/public/images/favoritoscab.png">
          </a>
        </div>
      </div>
      <div class="headSepV"></div>
      <div class="digiHeaderCell dHF1_outOf dHF1_oferta" style="max-width: 325px; padding: 0px 6px; <?php if (session('usuario')->margenesActivo == 0) {
        ?> width:45px; <?php } ?>">
        <div class="tHofe1 flex-center">
          ...
          @else
            ...
            @else
              <a alt="Desactiva tu modo PVP" onclick="ajaxActivarModoPVP({{session('usuario')->uData->codigo}}, 0, true)" class="title_pvp">
                PVD <!-- {{Illuminate\Support\Str::limit(session('usuario')->nombreTienda, 40)}} -->
              </a>
            @endif
      ...
      <div class="headSepV"></div>
      <div class="digiHeaderCell dHF1_2" style="min-width: 413px; <?php if (session("usuario")->margenesActivo == 1) { ?> visibility: hidden; <?php } ?>">
        <div style="display: table; vertical-align: middle;">
          <div style="display: table-cell; vertical-align: middle; padding-left: 10px;">
            <img src="/xweb/public/images/micomercial.png" width="15" height="15"/>
          </div>
          <div style="display: table-cell; vertical-align: middle; padding-left: 10px;">
            {{session("usuario")->uData->rnom}}
          </div>
          <div style="display: table-cell; vertical-align: middle; padding-left: 10px;">
            <a href="mailto:{{session('usuario')->uData->rmail}}">{{session("usuario")->uData->rmail}}</a>, {{session("usuario")->uData->rtel}} <?php if (session("usuario")->uData->rext != "161") { ?> ext. {{session("usuario")->uData->rext}} <?php } ?>
          </div>
        </div>
      </div>
      <div class="digiHeaderCell dHF1_3" style="width: 290px;">
        <div class="headSepV"></div>
        <div id="megaMenuMiCuenta" class="loginMegaMenu">
          <div class="wrap">
            <div class="demo-container">
              <div class="red">
                <ul id="mega-menu-login" class="mega-menu-login" style="width: 100%; list-style: none;padding: 0px; margin: 0px;">
                  <li></li>
                  <li class="menuLogin menuLogin2">
                    <a id="linkmenulogin" class="headPerfil dc-mega">
                      <img class="headPerfil1" src="/xweb/public/images/husericon.png">
                      
                      @if (true)

                        <?php
                          $cnom = session('usuario')->uData->cnom;
                          if ( strlen($cnom) >= 27 ) { $cnom = substr($cnom, 0, 24); $cnom .= "..."; }
                        ?>


                        <span class="headPerfil2">{{$cnom}}</span>
                      @else
                        <span class="headPerfil2">MI CUENTA</span>
                      @endif
                      <img class="headPerfil3" src="/xweb/public/images/haccicon.png">
                    </a>
                    <div class="sub-container non-mega" style="left: 64%; top: 21px; z-index: 1000;">
                      <ul class="sub" style="display: none; list-style: none">
                        <li>
                          <div class="micuentaContenido" id="despLog2">
                            <div class="miCTitu">Mi perfil</div>
                            <div class="miCTab">
                              <div class="miCCel1">
                                <img alt="Documentos" src="/xweb/public/images/micuenta0.png">
                              </div>
                              <div class="miCCel2">
                            ...
                            <div class="miCTab" style="">
                              ...
                              <div class="miCCel2">
                                <a style="color: black;" href="{{URL::to('modopvp')}}">{{T::tr('Modo PVP')}}</a>
                              </div>
                            </div>
                            ...
                            <div class="miCTab">
                              <div class="miCCel1">
                                <img alt="Envíos" src="/xweb/public/images/micuenta5.png">
                              </div>
                              <div class="miCCel2">
      ...
      <div class="digiHeaderCell dHF1_4" style="width: 181px;">
        <a href="/xweb/preguntasfrecuentes" style="font-size: 10pt;">Devoluciones y Garantías</a>
      </div>
      <!--<div class="headSepV"></div>
              ...
              <div class='red'>
                <ul class='mega-menu-login' style="width: 100%; margin-bottom: 0px; list-style: none;">
                  ...
                  <li class="menuLogin" style="margin-bottom: 2px;">
                    <a id="loginClickable">{{T::tr('Login | Registro')}}</a>
                    <ul>
                      <li>
...
@if(session('entorno')->nombrePagina == 'categoria' || session('entorno')->nombrePagina == 'categoria2')
  <div class="digiHeader cabr3" id="idDigiHeader" 
    <?php 
    if(session('usuario')->uData->codigo == 0) 
    {
      ?> style="height: 277px" <?php 
    }
    else 
    {
      if (session("usuario")->margenesActivo)
      {
        ?> style="height: 261px" <?php 
      }
    }?>>
@elseif(session('entorno')->nombrePagina == 'familia')
  <div class="digiHeader cabr3" id="idDigiHeader" <?php if (session("usuario")->margenesActivo) { ?> style="height: 283px;" <?php } ?>>
...
@elseif(session('entorno')->nombrePagina == 'articulo2')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'producto')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'cesta')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'cesta2')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'presupuesto')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'presupuesto2')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'presupuestomod')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'presupuestogenerado')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'documentos')
  <div class="digiHeader cabr4" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'documentos2')
  <div class="digiHeader cabr4" id="idDigiHeader">
...
@elseif(session('entorno')->nombrePagina == 'generadoranuncios')
  <div class="digiHeader cabazul" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'generadoranuncios2')
  <div class="digiHeader cabazul" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'generadorcarteltecno')
  <div class="digiHeader cabazul" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'favoritos')
  <div class="digiHeader cabr3" id="idDigiHeader" style="height: 283px;">
@elseif(session('entorno')->nombrePagina == 'misdocumentos')
  <div class="digiHeader cabazul" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'misdocumentos2')
  <div class="digiHeader cabazul" id="idDigiHeader">
...
@elseif(session('entorno')->nombrePagina == 'generarcsv')
  <div class="digiHeader cabazul" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'generarcsv2')
  <div class="digiHeader cabazul" id="idDigiHeader">
...
@elseif(session('entorno')->nombrePagina == 'proformajustificanteej')
  <div class="digiHeader cabr2" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'formularioemails')
  <div class="digiHeader cabazul" id="idDigiHeader">
@elseif(session('entorno')->nombrePagina == 'modopvp')
  <div class="digiHeader cabazul" id="idDigiHeader">
@else
...
@endif
  <div class="digiHead1">
    ...
    @if(session('usuario')->uData->codigo > 0)
      <div class="dH1Cell dH1C3">
        ...
        <div id="cestaAjax" class="dH1LinkCell dH1LinkCell2" <?php if (session("usuario")->margenesActivo) { ?> style="width: 184px;" <?php } ?>>
          <div class="dHIco">
            <span id="counterCesta" class="cabCestaNum">{{session('usuario')->uData->numArticulosCesta}}</span>
            <a href="{{URL::to('cesta')}}">
              <img alt="Cesta" src="/xweb/public/images/iconcesta2.png" width="29" height="36" />
            </a>
          </div>
          @if (session("usuario")->margenesActivo)
            <div class="dH1Link" style="width: 140px; padding-left: 0px;">
              <a class="hMicesta" href="{{URL::to('presupuesto')}}" style="font-family: 'montserratsemibold';">Mi presupuesto</a>
              <br/>
              <span class="cabCestaTotal">
                <a id="importePresupuesto" href="{{URL::to('presupuesto')}}">Total: {{Utils::numFormat(session('usuario')->uData->importeCesta)}}€</a>
              </span>
            </div>
          </div>
          @else
            <div class="dH1Link">
              ...
              <br/>
              <span class="cabCestaTotal">
                <a id="importeCesta" href="{{URL::to('cesta')}}"> {{Utils::numFormat(session('usuario')->uData->importeCesta)}}€</a>
              </span>
            </div>
          </div>
          @endif
                            ...
                            <div class="menuAppleTD">
                              <div class="menuAppleTD1">
                                <a href="/xweb/familia/4">
                                  <img src="/xweb/public/images/imac.webp" width="209" height="auto"  />
                                </a>
                              </div>
  ...
  @if (session('entorno')->nombrePagina == 'categoria' || session('entorno')->nombrePagina == 'ofertas')
    ...
    @endif
      <div class="catTituloTOc" <?php if (session('usuario')->margenesActivo == 1) { ?> style="margin-top: 4px;" <?php } ?>>
