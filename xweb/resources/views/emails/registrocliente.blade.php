<table style="border-collapse: collapse; border-spacing: 0" width="750">
	...
	<tr style="background: #313131; height: 40px">
		...
		<td colspan="6">
			<div style="font-size: 10pt; font-family: inherit; color: #dedede; font-weight: bold; font-family: Verdana, Arial, Helvetica, sans-serif">
				Bienvenido a DIGINOVA. A continuación le informamos de los datos aportados por usted:
			</div>
		</td>
	</tr>
	...
	<tr style="background-color: #eee">
		<td style="padding: 10px 5px; width: 38px;">
			<img src="https://diginova.es/xweb/images/chat_email.png" style="width: 16px; padding-left: 15px;">
		</td>
		<td style="font-size: 10pt; font-family: inherit; color: #0b2e48; text-align: left; padding-right: 10px; font-family: Verdana, Arial, Helvetica, sans-serif; width: 90px;">
			Observ.: 
		</td>
		<td style="font-size: 12pt; font-family: inherit; color: #3b444d; font-family: monospace; width: 247px;" colspan="5">	
			{{$datos['observaciones']}}
		</td>
	</tr>
	<tr style="background-color: #e4e4e4; display: none;">
		<td style="padding: 10px 5px; width: 38px;">
			<img src="https://diginova.es/xweb/images/padlock_email.png" style="width: 16px; padding-left: 15px;">
		</td>
		<td style="font-size: 10pt; font-family: inherit; color: #0b2e48; text-align: left; padding-right: 10px; font-family: Verdana, Arial, Helvetica, sans-serif; width: 90px;">
			Pulse sobre este enlace para activar la cuenta
		</td>
		<td style="font-size: 12pt; font-family: inherit; color: #3b444d; font-family: monospace; width: 247px;" colspan="5">	
			<!--<a href="{{URL::to('activarCuenta').'/'.$datos['claveactiv'].'/'.$datos['codigoCliente']}}" title="Activar">{{URL::to('activarCuenta').'/'.$datos['claveactiv'].'/'.$datos['codigoCliente']}}</a>-->
			<a href="https://diginova.es/xweb/activarCuenta/<?php echo $datos['claveactiv']; ?>/<?php echo $datos['codigoCliente']; ?>" title="Activar">Activar cuenta</a>
		</td>
	</tr>
	<tr style="background-color: #eee">
		<td style="padding: 10px 5px; width: 38px;">
	...
	<tr style="background: #313131; height: 40px">
		...
		<td colspan="6">
			<div style="font-size: 10pt; font-family: inherit; color: #dedede; font-weight: bold; font-family: Verdana, Arial, Helvetica, sans-serif">
				En breve, un comercial se pondrá en contacto con usted para finalizar el proceso de alta.
			</div>
		</td>
	</tr>
	<tr>
