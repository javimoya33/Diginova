...
<!--
                    ...
                    // Si se solicita un código de autenticación, introducir 123456
-->

			<?php 

                // 1234   https://sis-t.redsys.es:25443/sis/realizarPago
                $urlOK = "https://diginova.es/xweb/tpvpedidook/".$numero;
					...
					<div class="finCompraT" style="margin-bottom: 35px;">
						...
						<div class="finCompraTd">
							<div class="cestaDivBtn">
								<form name='ppagostar' action='https://sis-t.redsys.es:25443/sis/realizarPago' method='post'>  
									<input type='hidden' name='Ds_SignatureVersion' value='HMAC_SHA256_V1'/>
