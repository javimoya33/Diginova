		    			...
		    			<div class="catCol2">
		    				...
		    				<div class="catColumna catArticulos">
		    					<div id="filtradosCat" class="elementsOcasion">
		    						...
		    						@if ($categoria == 1125 || $categoria == 1126 || $categoria == 1118 || $categoria == 1160)
		    							@if (count($arrOfertas) > 0)
		    								<div id="divOfertasCategoria" class="contArtsOcasion contArtsOfertas">
				    							<?php
				    							$leftArticulo = -225;
												...
												$widthArticulo = 200;
												$topArticulo = 0;
												$arrArticulos = $arrOfertas;
												$esAccesorioComponente = false;
												$esFilaOfertas = true;
				    							?>

				    							@if (count($arrOfertas) > 3)
					    							<div id="flechaIzqOfertasCategoria" class="flechaOfertasCategoria catCol0DivMv" onclick="clickFlechaIzqOfertasCategoria(200)" style="left: 10px; display: none">
					    								<img src="/xweb/public/images/next.png" style="rotate: 180deg" />
					    							</div>

					    							<div id="flechaDerOfertasCategoria" class="flechaOfertasCategoria catCol0DivMv" onclick="clickFlechaDerOfertasCategoria(200)" style="right: 18px">
					    								<img src="/xweb/public/images/next.png" />
					    							</div>
				    							@endif

				    							@include("celda_articulo2")
				    						</div>
		    							@endif
		    						@endif
