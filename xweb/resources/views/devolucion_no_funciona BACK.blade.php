...
<div class="devoluciones">
	<div class="devoluciones1" id="devoluciones1">
		...
		<form id="fAniadir" name="fAniadir" enctype="multipart/form-data" method="post" action="/xweb/devolucion" onsubmit="return devolAdd(<?php echo $ccodcl ?>, '<?php echo $acodar; ?>', '<?php echo $nnumser; ?>', <?php echo $fdoc; ?>, document.getElementById('devolSelAveria').value, document.getElementById('devolObs').value);">
		        ...
		        <div class="devolArticulosObs">
		        	...
		        	<div class="devolArticulosObs2" id="devolArticulosObs2" style="vertical-align: top;">
				        ...
				        <div class="rmarepararoabonar devolPreg" id="rmarepararoabonar" style="">
				        	...
				        	<div class="rmarepararoabonar2"><div class="rmarepararoabonar2_1"><input type="radio" name="rreparar" id="rreparar1" value="1" onchange="preguntaDevolver('{{$tipoRMA}}')" /></div><div class="rmarepararoabonar2_2">Reparar</div></div>
