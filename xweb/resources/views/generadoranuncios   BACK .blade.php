					...
					<div id="div_scroll_articulos" onscroll="scrollArticulos(this)" style="overflow-y: scroll; height: 930px; overflow-x: hidden;">
						...
						@foreach($arrArticulos as $arrArticulo)
							...
							<?php
							    ...
							    $nombre_fichero = $_SERVER['DOCUMENT_ROOT'].'/xweb/public/fotobanners/art_'.strtolower($arrArticulo->ACODAR).'_1 copia.png';
							    if (file_exists($nombre_fichero)) {
							      	$imagenExiste = true;
						      		$urlFoto = '/xweb/public/fotobanners/art_'.strtolower($arrArticulo->ACODAR).'_1 copia.png';
							    }
								...
								<table id="table_datos_generador_anuncios" style="width: 100%; border-bottom: 1px #000 solid">
									...
									<tr>
										...
										<td colspan="2" style="width: 60%">
											<input type="text" id="input_dato_telefono" oninput="escribirDatoTelefono()" name="input_dato_telefono" placeholder="987 654 321" value="" style="width: 98%; float: right; margin-right: 0px;">
										</td>
									</tr>
									<tr>
										<td style="width: 15%">
										...
										<td colspan="2" style="width: 60%">
											<input type="text" id="input_dato_correo" oninput="escribirDatoCorreo()" name="input_dato_correo" placeholder="estebangarcia@gmail.com" value="" style="width: 98%; float: right; margin-right: 0px;">
										</td>
									</tr>
									<tr>
										<td style="width: 15%">
