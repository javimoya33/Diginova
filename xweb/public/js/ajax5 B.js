...
function actualizarCestaAjax(acodar)
{
    ...
    document.getElementById("cestaAdd" + acodar).style.backgroundImage = "url(../xweb/public/images/btnverarticulo1.jpg)";
    ...
    setTimeout(function()
    {
        document.getElementById("cestaAdd" + acodar).style.backgroundImage = "url(../xweb/public/images/btnverarticulo0.jpg)";
    }, 1500);
}
    ...
    for (var i = 0; i <= limiteArt; i++) 
    {
        (function(i) 
        {
            ...
            img.on('error', function(e) {
                ...
                $('#img_seleccion_' + i).attr('src', 'https://diginova.es/xweb/fotoartic/nofoto2tmp.jpg');
            });
        }(i));
    }
...
function mostrarCaracteristicasArtAnuncio(nombreArticulo)
{
    ...
    for (var i = 0; i < arrCaractArticulo3.length; i++) 
    {
        ...
        else if (((arrCaractArticulo4.indexOf('1GB') > -1) || (arrCaractArticulo4.indexOf('2GB') > -1) || (arrCaractArticulo4.indexOf('4GB') > -1) || (arrCaractArticulo4.indexOf('8GB') > -1) || (arrCaractArticulo4.indexOf('12GB') > -1) || (arrCaractArticulo4.indexOf('16GB') > -1) || (arrCaractArticulo4.indexOf('32GB') > -1)) && (!yaTieneRAM))
        {
            ...
            $('#table_caract_generador_anuncios').append(
                '<tr>' + 
                    ...
                    '<td style="width: 100%">' + 
                        ...
                        '<select id="radio_caract_gb_ram" name="radio_caract_gb_ram" class="select_caract_anuncio" style="width: 45%; margin-bottom: -2px;">' + 
                    ...
                    '<td colspan="3">' + 
                        ...
                        '<select id="radio_caract_ddr_ram" name="radio_caract_ddr_ram" class="select_caract_anuncio" style="width: 22%; float: left; margin-bottom: -2px;">' + 
            ...
            $("#radio_caract_gb_ram").change(function()
            {
                var enlace = '/public/fotobanners/iconos/ram-' + $('#radio_caract_gb_ram').val() + '-ddr' + $('#radio_caract_ddr_ram').val() + '.png';
                enlace.replace("-EMMC", "");
                $("#img_caract_ram").attr("src", enlace);
            });

            $("#radio_caract_ddr_ram").change(function()
            {
                var enlace = '/public/fotobanners/iconos/ram-' + $('#radio_caract_gb_ram').val() + '-ddr' + $('#radio_caract_ddr_ram').val() + '.png';
                enlace.replace("-EMMC", "");
                $("#img_caract_ram").attr("src", enlace);
        ...
        else if ((arrCaractArticulo4.indexOf('1TB') > -1) || (arrCaractArticulo4.indexOf('120GB') > -1) || (arrCaractArticulo4.indexOf('128GB') > -1) || (arrCaractArticulo4.indexOf('160GB') > -1) || (arrCaractArticulo4.indexOf('180GB') > -1) || (arrCaractArticulo4.indexOf('240GB') > -1) || (arrCaractArticulo4.indexOf('250GB') > -1) || (arrCaractArticulo4.indexOf('256GB') > -1) || (arrCaractArticulo4.indexOf('320GB') > -1) || (arrCaractArticulo4.indexOf('480GB') > -1) || (arrCaractArticulo4.indexOf('500GB') > -1) || (arrCaractArticulo4.indexOf('512GB') > -1) || (arrCaractArticulo4.indexOf('120') > -1) || (arrCaractArticulo4.indexOf('128') > -1) || (arrCaractArticulo4.indexOf('160') > -1) || (arrCaractArticulo4.indexOf('180') > -1) || (arrCaractArticulo4.indexOf('240') > -1) || (arrCaractArticulo4.indexOf('250') > -1) || (arrCaractArticulo4.indexOf('256') > -1) || (arrCaractArticulo4.indexOf('320') > -1) || (arrCaractArticulo4.indexOf('480') > -1) || (arrCaractArticulo4.indexOf('500') > -1) || (arrCaractArticulo4.indexOf('512') > -1) || (arrCaractArticulo4.indexOf('32GB') > -1))
        {
            ...
            $('#table_caract_generador_anuncios').append(
                '<tr>' + 
                    ...
                    '<td style="width: 100%">' + 
                        '<div style="width: 45%; float: left; font-size: 10pt; font-weight: 100; margin-left: 10px;">Capacidad: </div>' + 
                        '<select id="radio_caract_gb_dd" name="radio_caract_gb_dd" class="select_caract_anuncio" style="width: 45%; margin-bottom: -2px;">' + 
                            '<option value="32">32GB</option>' + 
                    ...
                    '<td colspan="3">' + 
                        ...
                        '<select id="radio_caract_tipo_dd" name="radio_caract_tipo_dd" class="select_caract_anuncio" style="width: 22%; float: left; margin-bottom: -2px;">' + 
            ...
            $("#radio_caract_gb_dd").change(function()
            {
                var enlace = '/public/fotobanners/iconos/discoduro-' + $('#radio_caract_gb_dd').val() + '-' + $('#radio_caract_tipo_dd').val() + '.png';
                $("#img_caract_discoduro").attr("src", enlace);
            });

            $("#radio_caract_tipo_dd").change(function()
            {
                var enlace = '/public/fotobanners/iconos/discoduro-' + $('#radio_caract_gb_dd').val() + '-' + $('#radio_caract_tipo_dd').val() + '.png';
                $("#img_caract_discoduro").attr("src", enlace);
            });
        ...
        else if ((arrCaractArticulo4.indexOf('DVD') > -1) && (arrCaractArticulo4.indexOf('NO-DVD') == -1) && (arrCaractArticulo4.indexOf('NODVD') == -1))
        {
            ...
            $('#table_caract_generador_anuncios').append(
                '<tr>' + 
                    ...
                    '<td style="width: 100%">' + 
                        ...
                        '<select id="radio_caract_version_dvd" name="radio_caract_version_dvd" class="select_caract_anuncio" ' + 
            ...
            {
                var enlace = '/public/fotobanners/iconos/iconos/' + $('#radio_caract_version_dvd').val() + '.png';
        ...
        else if ((arrCaractArticulo4.indexOf('W7') > -1) || (arrCaractArticulo4.indexOf('W8') > -1) || (arrCaractArticulo4.indexOf('W9') > -1) || (arrCaractArticulo4.indexOf('W10') > -1) || (arrCaractArticulo4.indexOf('CHROME') > -1))
        {
            ...
            $('#table_caract_generador_anuncios').append(
                '<tr>' + 
                    ...
                    '<td style="width: 100%">' + 
                        ...
                        '<select id="radio_caract_version_so" name="radio_caract_version_so" class="select_caract_anuncio" style="width: 65%; margin-bottom: -2px;">' + 
                    ...
                    '<td colspan="3">' + 
                        ...
                        '<select id="radio_caract_tipo_so" name="radio_caract_tipo_so" class="select_caract_anuncio" style="width: 22%; float: left; margin-bottom: -2px;">' + 
                            '<option value=""></option>' + 
            ...
            $("#radio_caract_version_so").change(function()
            {


                var enlace = '/public/fotobanners/iconos/windows-' + $('#radio_caract_version_so').val() + '-' + $('#radio_caract_tipo_so').val() + '.png';

                if ($('#radio_caract_version_so').val() == 'Chrome')
                {
                    enlace = '/public/fotobanners/iconos/chrome-os.png';
                }
            ...
            $("#radio_caract_tipo_so").change(function()
            {
                var enlace = '/public/fotobanners/iconos/windows-' + $('#radio_caract_version_so').val() + '-' + $('#radio_caract_tipo_so').val() + '.png';

                if ($('#radio_caract_tipo_so').val() == 'Chrome')
                {
                    enlace = 'chrome-os.png';
                }
...
function mostrarCaractAnuncio(caract, tipo)
{
    if ($('#check_caract_' + caract).is(":checked"))
    {
        if (tipo == 1)
        {
            $('#div_carac2_icon_articulo_seleccionado').append('<img src="/public/fotobanners/iconos/' + nombreImagen + '" id="img_caract_' + caract + '" />');
        }
        else if (tipo == 2)
        {
            $('#div_carac2_icon_articulo_seleccionado').append('<img src="/public/fotobanners/iconos/' + nombreImagen2 + '" id="img_caract_' + caract + '" />');
        }
        else if (tipo == 3)
        {
            $('#div_carac2_icon_articulo_seleccionado').append('<img src="/public/fotobanners/iconos/' + nombreImagen2 + '" id="img_caract_' + caract + '" />');
...
function buscarArticulosAnuncio()
{
    $('#buscar_generador').on('input', function()
    {
        ...
        setTimeout(function()
        {
            ...
            {
                $.ajax({
                    url: '/buscararticulosanuncio/' + $('#buscar_generador').val(),
                    type: 'get',
                    contentType: false,
                    processData: false,
                    success: function(response) {
...
{
    //pulsarArticuloParaAnuncio('Ordenador Lenovo M93P SFF GRADO B (Intel Core i3 4130T 2.9GHz/8GB/120SSD/DVDRW/W8P) Preinstalado', 99, '/public/fotobanners/art_6910lenm93p3gb_1 copia.png');
...
{
    $.ajax({
        url: '/marcarfavorito/' + ccodcl + '/' + acodar + '/' + favorito,
        type: 'get',
        contentType: false,
        processData: false,
        success: function(response) {
...
function devolSel(valorSel, tipoDeRma, codigocli, dif)
{
    ...
    console.log("t1");
    if ( ( tipoDeRma == "DOA" && dif >= 3 && (valorSel >= 55 && valorSel <= 63) ) && codigocli != 47 )
    {console.log("t2");
...
function preguntaDevolver(tipoDeRma)
{
    if ( document.getElementById("rreparar1").checked )
    {
        ...
        if ( tipoDeRma == "RMA" )
        {
            document.getElementById("pregunta").innerHTML += "<div class='devolPreg' id='devolPreg3'><div style='font-weight: bold;'>Reparaci\u00F3n del producto</div><br /><div>Trataremos de realizar la reparaci\u00F3n del producto siempre que sea posible<br /></div></div>";
        }
        ...
        (function(i) 
        {
            ...
            $("a[name ='cestaAdd_"+i+"']").click(function() {
                ...
                if (cant_articulo > limite_cantidad)
                {
                    ...
                    $("input[name = 'masCantidad_"+i+"']").attr('src', 'images/artmasoff.png');
                }
